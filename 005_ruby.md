...
The community cookbook we're using is the [rvm cookbook](https://supermarket.chef.io/cookbooks/rvm).  Fortunately for use, the Chef DK can pull this cookbook into our recipes automatically without needing to download it.
...
First, you need to add the dependency on the rvm cookbook to your metadata file in your cookbook.
